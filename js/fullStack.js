...
function speech(id){
  console.log(id)
recognition.addEventListener("result", function fun(e) { //if stop speaking and start again, speech recognition no longer works because it only runs after it hears a 'result' event. When the result event is over, the event listener unbinds itself. So must include another function that calls speech recognition when it ends.
